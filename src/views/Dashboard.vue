        ...
        <nav class="flex flex-col gap-1 " :class="isSidebarCollapsed ? 'p-1' : 'p-2'">
          ...
          <div class="">
            <button @click="toggleMenu3"
              ...
              <i class="fas" :class="[isMenu3Open ? 'fa-chevron-up' : 'fa-chevron-down', isSidebarCollapsed ? 'mini' : 'text-base']"></i>
            </button>
            <div v-if="isMenu3Open" :class="['mt-1 space-y-2 transition-all duration-300', isSidebarCollapsed ? 'absolute z-10 rounded-md left-16 bg-zinc-50 shadow-lg w-48 p-2' : 'pl-8']">
              <a href="/area-do-aluno/carreiras" class="flex gap-2 items-center text-sm text-gray-600 hover:text-gray-900"><i class="fa-solid fa-user-astronaut"></i> Minha Carreira</a>
              <a href="/area-do-aluno/materias" class="flex gap-2 items-center text-sm text-gray-600 hover:text-gray-900"><i class="fa-solid fa-book"></i> Minhas Matérias</a>
