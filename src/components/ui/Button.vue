...
const button = tv({
    ...
    variants: {
        variant: {
            base: 'bg-[#21BFCA] text-white font-bold px-[16px] py-[10px] border-[1px] border-[#2EC1CB] hover:bg-[#42D3DD]', //Novo Layout
            baseDisable: 'bg-white text-[#21BFCA] font-bold px-[16px] py-[10px] border-[1px] border-[#2EC1CB]', //NovoLaout
