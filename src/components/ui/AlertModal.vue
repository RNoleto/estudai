  ...
  <div v-if="visible" class="fixed inset-0 flex items-center justify-center bg-black backdrop-blur-sm bg-opacity-50 z-20">
    <div class="bg-white p-6 rounded-2xl shadow-lg w-80 text-center">
      <div class="flex justify-center mb-4">
        <span v-if="type === 'success'" class="text-baseGreen text-4xl"><i class="fa-solid fa-check"></i></span>
        <span v-if="type === 'error'" class="text-baseRed text-4xl"><i class="fa-solid fa-ban"></i></span>
      ...
      <div class="flex gap-1 mt-4">
        <Button v-if="showButton" @click="$emit('close')" variant="base" size="full">
          Fechar
        </Button>
